      ...
      <section className="flex flex-col items-center h-screen md:flex-row">
        ...
        <div className="flex items-center justify-center w-1/3 px-6 bg-white">
          <div className="w-full h-100">
            ...
            <a href={`${API_BASE_URL}/user/google`} className="block w-full px-4 py-3 font-semibold text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:bg-gray-100">
